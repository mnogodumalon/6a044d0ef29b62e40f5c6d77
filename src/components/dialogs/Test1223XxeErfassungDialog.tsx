...
interface Test1223XxeErfassungDialogProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (fields: Test1223XxeErfassung['fields']) => Promise<void>;
  defaultValues?: Test1223XxeErfassung['fields'];
  enablePhotoScan?: boolean;
  enablePhotoLocation?: boolean;
}

export function Test1223XxeErfassungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: Test1223XxeErfassungDialogProps) {
  const [fields, setFields] = useState<Partial<Test1223XxeErfassung['fields']>>({});
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'test_1223_xxe_erfassung');
      await onSubmit(clean as Test1223XxeErfassung['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      setFields(prev => {
        ...
        return merged as Partial<Test1223XxeErfassung['fields']>;
      });
      setAiText('');
      setScanSuccess(true);
  ...
  const DIALOG_INTENT = defaultValues ? 'Test 1223 xxe Erfassung bearbeiten' : 'Test 1223 xxe Erfassung hinzufügen';
