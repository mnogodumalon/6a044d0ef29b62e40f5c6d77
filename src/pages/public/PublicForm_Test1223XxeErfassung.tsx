...
const PROXY_BASE = '';
const APP_ID = '6a044ccc8e5ab963989d840e';
...
export default function PublicFormTest1223XxeErfassung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Test 1223 xxe Erfassung — Formular</h1>
        </div>
